...
git branch -M main
git remote add origin git@github.com:ITC-CRIB/quakefeed
```

## Push the initial commit to a new repo on GitHub

Go to
[https://github.com/organizations/ITC-CRIB/repositories/new](https://github.com/organizations/ITC-CRIB/repositories/new)
and create a new repository named `quakefeed` as an empty repository, then push your commits to GitHub:
...
automatically ([here](https://github.com/ITC-CRIB/quakefeed/issues?q=author%3Aapp%2Fgithub-actions)). Resolve them to complete the
